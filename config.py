...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7607815278:AAEZNnnrbWaZ_7v8ym3FyZRMiPc-BWdHUdM")

#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "23987821"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "3fe9ad7f03fe190f246734f52a0869f1")

BAN = int(os.environ.get("BAN", "7078069446")) #Owner user id
OWNER = os.environ.get("OWNER", "CarteIApha") #Owner username
OWNER_ID = int(os.environ.get("OWNER_ID", "7078069446")) #Owner user id
...
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002411048759"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002449490716"))
FORCESUB_CHANNEL3 = int(os.environ.get("FORCESUB_CHANNEL3", "-1002434337280"))
...
try:
    ADMINS=[7078069446]
    for x in (os.environ.get("ADMINS", "7078069446").split()):
        ADMINS.append(int(x))
except ValueError:
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>» ʙʏ @sugarhub</b>")
